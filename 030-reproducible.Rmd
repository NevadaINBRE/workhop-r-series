...
<video width="100%" autoplay muted loop controls>
  <source src="media/vid/03-creating-project-with-renv.webm" type="video/webm">
</video>
...
This type of storage can reproducibly track any changes that have been made to your large files over the course of your project and helps in avoiding a directory that looks like: gif_v1, gif_v2, gif_v3, etc.
